...
execute if score @s version matches 1.. run tellraw @s [{"text":"[My Action Bar] ","color":"#fff04d","bold":true},{"text":"Installed Version: ","color":"gray"},{"text":"v1.4","color":"gold","bold":true}]
